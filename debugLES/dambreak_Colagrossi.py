...
if useHex:
    ...
    hmin = he/4.0;
    hPhi = he/4.0;#/4.0
    domain.PUMIMesh=MeshAdaptPUMI.MeshAdaptPUMI(hmax=hmax, hmin=hmin, hPhi = hPhi, adaptMesh=adaptMeshFlag, numIter=adaptMesh_numIter, numAdaptSteps=adaptMesh_nSteps,  sfConfig="VMS",targetError = 1.0,logType="off",reconstructedFlag=2,gradingFact=1.2)
    ...
    #domain.PUMIMesh=MeshAdaptPUMI.MeshAdaptPUMI(hmax=hmax, hmin=hmin, hPhi = hPhi, adaptMesh=adaptMeshFlag, numIter=adaptMesh_numIter, numAdaptSteps=adaptMesh_nSteps,  sfConfig="uniform",reconstructedFlag=2,gradingFact=1.2)
    ...
    domain.PUMIMesh.loadModelAndMesh("Reconstructed.dmg", "2-Proc/Reconstructed.smb")
...
if(opts.adapt):
    ...
    he = 0.015#tank_dim[0] / float(4 * refinement - 1)
